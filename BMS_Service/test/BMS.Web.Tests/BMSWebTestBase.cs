...
{
    public abstract class BMSWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BMSWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BMSWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BMSDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BMSDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BMSDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BMSDbContext, Task<T>> func)
        {
            T result;
